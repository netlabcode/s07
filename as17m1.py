...
val1 = client.get_node("ns=2;i=598")
val2 = client.get_node("ns=2;i=599")
val3 = client.get_node("ns=2;i=600")
val4 = client.get_node("ns=2;i=601")
val5 = client.get_node("ns=2;i=602")
val6 = client.get_node("ns=2;i=603")
val7 = client.get_node("ns=2;i=604")
