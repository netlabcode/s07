...
val1 = client.get_node("ns=2;i=605")
val2 = client.get_node("ns=2;i=606")
val3 = client.get_node("ns=2;i=607")
val4 = client.get_node("ns=2;i=608")
val5 = client.get_node("ns=2;i=609")
val6 = client.get_node("ns=2;i=610")
